...
@class [template] dapp_selectAITAccount
@constructor
*/

Template['dapp_selectAITAccount'].onCreated(function(){
    if(this.data ) {
        if(this.data.value) {
...
Template['dapp_selectAITAccount'].helpers({
    /**
    ...
    */
    'isNotEtherUnit': function() {
        return AITTools.getUnit().toLowerCase() !== 'ether';
    },
    /**
    Check if the current selected unit is not ether
...
Template['dapp_selectAITAccount'].events({
    /**
