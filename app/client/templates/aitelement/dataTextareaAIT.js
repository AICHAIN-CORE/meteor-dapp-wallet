...
@class [template] dapp_dataTextareaAIT
@constructor
*/

Template['dapp_dataTextareaAIT'].onCreated(function(){
...
Template['dapp_dataTextareaAIT'].onRendered(function(){
    if(this.data && this.data.value) {
        this.$('textarea').trigger('change');
    }
});

Template['dapp_dataTextareaAIT'].helpers({
    /**
...
Template['dapp_dataTextareaAIT'].events({
    /**
